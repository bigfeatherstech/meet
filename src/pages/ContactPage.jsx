...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="contact-hero"
        className={`relative py-20 md:py-32 overflow-hidden text-white transition-all duration-1000 ${visibleSections.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        style={{ 
      ...
      >
        ...
        <div className="samsung-container relative z-10">
          <div className="max-w-3xl">
            ...
            <button 
              className="bg-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg animate-fade-in-up animate-delay-400 flex items-center gap-2 group"
      ...
      <div className="relative -mt-12 samsung-container">
        ...
        >
          {achievements.map((achievement, index) => (
            ...
            >
              <div 
                className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 group-hover:scale-110 transition-all duration-300 animate-bounce-in text-white"
                style={{ backgroundColor: bluePrimary }}
              >
                <span className="text-2xl">{achievement.icon}</span>
              </div>
              <div className={`text-3xl font-bold mb-2 animate-count-up`}
                style={{ color: bluePrimary }}>
      ...
      <section
        ...
        className="py-20 samsung-container overflow-hidden" style={{marginTop:'3%',paddingBottom:'3%'}}
      >
        <div className={`grid lg:grid-cols-2 gap-16 transition-all duration-1000 ${visibleSections.form ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="group">
                      <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                        <FiUser className="text-gray-400 group-focus-within:transition-colors" 
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-none transition-all duration-300"
                    ...
                    <div className="group">
                      <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                        <FiMail className="text-gray-400 group-focus-within:transition-colors"
                          style={{ '--tw-text-opacity': 1, color: `rgba(0, 42, 100, var(--tw-text-opacity))` }} />
                        Email Address *
                      </label>
                      <input
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="group">
                      <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                        <FiFlag className="text-gray-400 group-focus-within:transition-colors"
                          style={{ '--tw-text-opacity': 1, color: `rgba(0, 42, 100, var(--tw-text-opacity))` }} />
                        Country *
                      </label>
                      <Select
                        ...
                        styles={{
                          control: (base) => ({
                            ...
                            '&:focus-within': {
                              borderColor: bluePrimary,
                              boxShadow: `0 0 0 2px ${bluePrimary}33`
                            }
                          }),
                          option: (base, state) => ({
                            ...base,
                            backgroundColor: state.isSelected ? bluePrimary : state.isFocused ? `${bluePrimary}15` : 'white',
                            color: state.isSelected ? 'white' : '#374151',
                            '&:hover': {
                              backgroundColor: `${bluePrimary}15`
                            }
                          })
                        }}
                        required
                    ...
                    <div className="group">
                      <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                        <FiBriefcase className="text-gray-400 group-focus-within:transition-colors"
                          style={{ '--tw-text-opacity': 1, color: `rgba(0, 42, 100, var(--tw-text-opacity))` }} />
                        Company (Optional)
                      </label>
                      <input
                  ...
                  <div className="group">
                    <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                      <FiPhone className="text-gray-400 group-focus-within:transition-colors"
                        style={{ '--tw-text-opacity': 1, color: `rgba(0, 42, 100, var(--tw-text-opacity))` }} />
                    ...
                    <PhoneInput
                      ...
                      className="PhoneInput px-4 py-3 rounded-xl border border-gray-300 focus:outline-none transition-all duration-300"
                      style={{ '--tw-border-opacity': 1, '--tw-ring-opacity': 0.2, '--tw-ring-color': `rgba(0, 42, 100, var(--tw-ring-opacity))` }}
                    />
                  </div>
                  ...
                  <div className="group">
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:outline-none transition-all duration-300 resize-none"
                      style={{ '--tw-border-opacity': 1, '--tw-ring-opacity': 0.2, '--tw-ring-color': `rgba(0, 42, 100, var(--tw-ring-opacity))` }}
                  ...
                  <button
                    ...
                    className="w-full text-white py-4 rounded-xl font-semibold hover:shadow-xl transition-all duration-300 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 group/btn"
          ...
          <div className="space-y-8">
            <div 
              className="rounded-3xl p-8 text-white animate-pulse-gentle"
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div 
                        className="p-3 rounded-xl text-white group-hover:scale-110 transition-transform duration-300"
                        style={{ backgroundColor: bluePrimary }}
                      >
                        {info.icon}
                      </div>
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 samsung-container mx-auto">
        <div className="flex justify-center items-center gap-3 mb-6">
          ...
          >
            <FiMessageSquare className="text-2xl" style={{ color: bluePrimary }} />
          </div>
          <div className=''>
        ...
        <div className="flex justify-center item-center gap-2 mb-6">
          {faqCategories.map(category => (
            <button
              ...
              style={activeTab === category.id ? { background: `linear-gradient(to right, ${bluePrimary}, ${blueSecondary})` } : {}}
            >
              {category.title}
            </button>
          ))}
        ...
        <div className="space-y-4">
          {activeCategory?.questions.map((faq, index) => (
            <div
              key={index}
              className="border border-gray-200 rounded-xl p-4 hover:bg-blue-50 transition-all duration-300 group cursor-pointer"
              style={{ '--tw-border-opacity': 1, borderColor: bluePrimary }}
            >
              <div className="flex items-start gap-3">
                ...
                ></div>
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2 group-hover:transition-colors duration-300"
                    style={{ '--tw-text-opacity': 1, color: `rgba(0, 42, 100, var(--tw-text-opacity))` }}>
                    {faq.q}
                  </h4>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                <FiGlobe style={{ color: bluePrimary }} />
                Connect With Us
              </h3>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                />
                <button 
                  className="w-full bg-white py-3 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 flex items-center justify-center gap-2 group"
                  style={{ color: bluePrimary }}
                >
                  Subscribe Now
                  <FiArrowRight className="group-hover:translate-x-1 transition-transform duration-300" />
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 p-8">
              ...
              <div className="space-y-4">
                <button className="w-full flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:bg-blue-50 transition-all duration-300 group"
                  style={{ '--tw-border-opacity': 1, borderColor: bluePrimary }}>
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg" style={{ backgroundColor: `${bluePrimary}15` }}>
                      <FiHeadphones style={{ color: bluePrimary }} />
                    </div>
                  ...
                  <FiArrowRight className="text-gray-400 group-hover:transition-all duration-300"
                    style={{ '--tw-text-opacity': 1, color: `rgba(0, 42, 100, var(--tw-text-opacity))` }} />
                </button>
      ...
      <section className="py-20 samsung-container" style={{marginBottom:"1%"}}>
        <div 
