...
const CareerPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gray-50">
        <div className="samsung-container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Join Meet Appliances Ltd.?</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="samsung-container">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center mt-10">Our Hiring Process</h2>
      ...
      <section className="py-20 samsung-container ">
        <div 
          className="rounded-3xl p-12 text-center animate-pulse-gentle mt-10 mb-10"
